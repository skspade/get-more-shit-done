...
const { safeReadFile, normalizePhaseName, execGit, findPhaseInternal, output, error } = require('./core.cjs');
...
// cmdValidateHealth removed — consumers use validation.cjs validateProjectHealth
// (see Phase 67: Auto-Repair and Consumer Migration)
